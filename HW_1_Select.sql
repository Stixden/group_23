...
select * from students where name like '%a%' or name like '%а%';  -- eng a + russian а 
...
select * from students where id>40;  -- if need to include 40 need to use >=40

-- 20. Вывести пользователя у которых id меньше 30
select * from students where id<30;  -- if need to include 30 need to use <=30

-- 21. Вывести пользователя у которых id меньше 27 или больше 88
select * from students where id not between 27 and 88;
